...
exports.getset = ["k","v"];
exports.hdel = ["k","field"];
exports.hexists = ["k","field"];
exports.hget = ["k","field"];
exports.hgetall = ["key"];
exports.hincrby = ["k","field","n"];
exports.hkeys = ["k"];
exports.hlen = ["k"];
exports.hmget = ["k","fields"];
exports.hmset = ["k","items"];
exports.hset = ["k","field","v"];
exports.incr = ["k"];
exports.incrby = ["k","n"];
...
exports.setnx = ["k","v"];
exports.sinter = ["keys"];
exports.sinterstore = ["k_dest","keys"];
exports.sismember = ["k","v"];
exports.smembers = ["key"];
exports.smove = ["k","k_dest","v"];
exports.spop = ["k"];
exports.srandmember = ["k"];
exports.srem = ["k","v"];
exports.strlen = ["k"];
exports.sunion = ["keys"];
exports.sunionstore = ["k_dest","keys"];
exports.type = ["k"];
